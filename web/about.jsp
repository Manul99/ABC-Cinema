<%-- 
    Document   : about
    Created on : Jan 11, 2023, 1:15:59 AM
    Author     : manul
--%>
...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <center><div class="border border-danger w-50 mx-auto p-5">
        <h1 style="color:white">About Us</h1>
         
         <p style="color:white">ABC Cinemas (Associated British Cinemas) was a cinema chain in the United Kingdom. Originally a wholly owned subsidiary of Associated British Picture Corporation (ABPC), it operated between the 1930s and the 1980s. The brand name was reused in the 1990s until 2000.
            </p>
                </div> </center> 
            <br><br>
            <div class="d-flex">
            <center><div class="vision border border-danger w-50 mx-auto p-5">     
  <h1 style="color:white">OUR VISION</h1>
  
  <p style="color:white">The trusted leader in Cinema and its related Entertainment and to be Sri Lanka’s first multi-sensory luxury entertainment company that challenges industry standards by providing creative solutions to customers from all walks of life.</p>
                </div></center>
            <br>
            <center><div class="mission border border-danger w-55 mx-auto p-5">
  <h1 style="color:white">OUR MISSION</h1>
  
  <p style="color:white">The epitome of excellence in entertainment while being the beacon of innovation, hope and change with a sustainable value to all our stakeholders</p>
                </div></center>
            </div>
        </section>
        <br><br>
